...
const getProducts = async (req, res) => {
    ...
    // Price range can be passed as minPrice and maxPrice query params
    const priceFilter = {};
    ...
    const products = await Product.find({ ...keyword, ...category, ...color, ...price });
    res.json(products);
};
...
const createProduct = async (req, res) => {
    const { name, price, description, image, category, color, stock } = req.body;
